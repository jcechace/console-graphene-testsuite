 ...
 * @author jcechace
 */
public class HomepageSectionFragment extends BaseFragment {
    ...
    public void close() {
        String closedClass = PropUtils.get("homepage.section.closed.class");
        // TODO: workaround, remove this once resolved
        getHeader().click();
        if (isOpened()) {
            getHeader().click();
    ...
    public WebElement getHeader() {
        By selector = By.className(PropUtils.get("homepage.section.header.class"));
